...
function UserCartWarpper({ cartItems, setOpenCartSheet }) {
            ...
            <div className="mt-8 space-y-4">
                {
                    cartItems && cartItems.length > 0 ?
                        cartItems.map(item => <UserCartItemsContent cartItem={item} key={item?.productId} />) : null
                }
            </div>
            <div className="mt-8 space-y-4">
...
export default UserCartWarpper